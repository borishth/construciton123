    ...
    <View style={[styles.container, { backgroundColor: t.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={[styles.card, { backgroundColor: t.card, borderColor: t.cardBorder }]}>
          ...
          <TextInput
            style={[styles.input, { backgroundColor: t.searchBg, color: t.textPrimary, borderColor: t.cardBorder }]}
          ...
          <TextInput
            style={[styles.input, styles.textArea, { backgroundColor: t.searchBg, color: t.textPrimary, borderColor: t.cardBorder }]}
          ...
          <TouchableOpacity
            style={[styles.submitBtn, { backgroundColor: t.blue }, loading && { opacity: 0.7 }]}
