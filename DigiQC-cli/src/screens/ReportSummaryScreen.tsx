...
type Props = NativeStackScreenProps<RootStackParamList, 'ReportSummary'>;
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
              ...
              <View key={i} style={styles.defectCard}>
                ...
                <View style={styles.defectBody}>
                  ...
                  <View style={styles.correctiveAction}>
                    ...
                    <Text style={styles.actionText}>Corrective action required to resolve {r.defectType?.toLowerCase() || 'issue'}.</Text>
                  </View>
                </View>
              </View>
            ))}
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.reset({ index: 0, routes: [{ name: 'MainTabs' }, { name: 'Reports' as any }] })}
        >
