...
export default function HomeTab() {
  ...
  const stats = [
    { value: '124', label: 'Inspections', icon: 'assignment-turned-in' as const, color: t.blue, bg: t.blueSoft },
    { value: '08', label: 'Pending', icon: 'pending-actions' as const, color: t.amber, bg: t.amberSoft },
    { value: '92', label: 'Completed', icon: 'verified' as const, color: t.green, bg: t.greenSoft },
    { value: '14', label: 'Issues', icon: 'error-outline' as const, color: t.red, bg: t.redSoft },
  ];
