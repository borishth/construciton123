...
export default function ChecklistScreen() {
  ...
  const { projectName, siteName, structureType, checklistType, date, inspectorName } = useLocalSearchParams();
  ...
  const handleSubmit = async () => {
    ...
    router.push({
      pathname: '/report-summary' as any,
      params: {
        reportId,
        projectName: projectName as string,
        siteName: siteName as string,
              ...
              <View style={styles.cardTop}>
                <View style={styles.itemLeft}>
                  <View style={[styles.itemIcon, { backgroundColor: '#e8f0fe' }]}>
                    <MaterialIcons name={item.icon as any} size={20} color="#005bbf" />
                  </View>
